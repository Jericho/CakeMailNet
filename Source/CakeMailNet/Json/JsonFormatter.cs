...
namespace CakeMailNet.Json
{
	internal class JsonFormatter : MediaTypeFormatterBase
	{
		...
		internal static readonly CakeMailNetJsonSerializerContext SerializationContext;
		internal static readonly CakeMailNetJsonSerializerContext DeserializationContext;
		...
		static JsonFormatter()
		{
			...
			SerializationContext = new CakeMailNetJsonSerializerContext(SerializerOptions);
			DeserializationContext = new CakeMailNetJsonSerializerContext(DeserializerOptions);
		}
		...
		{
			if (value != null && type == typeof(JsonObject))
			{
				/*
