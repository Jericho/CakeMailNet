...
{
	/// <summary>
	/// Diagnostic handler for requests dispatched to the CakeMail next-gen API.
	/// </summary>
	...
	internal class DiagnosticHandler : IHttpFilter
	{
		...
		internal const string DIAGNOSTIC_ID_HEADER_NAME = "CakeMailNet-Diagnostic-Id";
		...
		public void OnResponse(IResponse response, bool httpErrorAsException)
		{
			...
			if (DiagnosticsInfo.TryGetValue(diagnosticId, out DiagnosticInfo diagnosticInfo))
			{
				...
				catch (Exception e)
				{
					...
					{
						_logger.LogError(e, "An exception occurred when inspecting the response from CakeMail");
					}
				}
				finally
				{
