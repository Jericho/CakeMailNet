...
namespace CakeNet.IntegrationTests
{
	public class Program
	{
		...
		private static string GenerateAttributesForSerializerContext()
		{
			...
			var baseNamespace = "CakeNet.Models";
			var allTypes = System.Reflection.Assembly
				.GetAssembly(typeof(CakeMailNetClient))
				.GetTypes()
		...
		private static LoggingConfiguration GetNLogConfiguration()
		{
			...
			if (!string.IsNullOrEmpty(logzioToken))
			{
				...
				logzioTarget.ContextProperties.Add(new TargetPropertyWithContext("source", "CakeNet_integration_tests"));
				logzioTarget.ContextProperties.Add(new TargetPropertyWithContext("CakeNet-Version", CakeMailNetClient.Version));
